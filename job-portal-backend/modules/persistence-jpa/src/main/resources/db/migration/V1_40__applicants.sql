...
CREATE INDEX ix_applicant_experience__applicant ON applicant_experience(applicant_id);
...
CREATE INDEX ix_applicant_education__applicant ON applicant_education(applicant_id);
...
CREATE UNIQUE INDEX uq_applicant_skill__applicant_name ON applicant_skill(applicant_id, name);
...
COMMENT ON TABLE applicants IS 'Perfil del postulante (CV).';
