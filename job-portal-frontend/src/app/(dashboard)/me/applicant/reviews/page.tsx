            ...
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-slate-600">
                  Aquí verás tu historial de evaluaciones y feedback asociados a procesos y experiencias.
                </p>
              </div>
            </div>
          </header>
          ...
          <section className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            <div className="p-6 sm:p-8">
              ...
              <h2 className="mt-2 text-lg sm:text-xl font-semibold text-slate-900">
                Estamos preparando tu historial de evaluaciones
              </h2>

              <p className="mt-2 text-slate-600">
                Esta sección se implementará en una siguiente iteración del MVP. Mostraremos el historial con un formato
                claro y verificable.
              </p>
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-1 text-sm text-slate-600">Listado y detalle por proceso.</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <p className="text-sm font-semibold text-slate-900">Transparencia</p>
                  <p className="mt-1 text-sm text-slate-600">Contexto y trazabilidad.</p>
                </div>
              </div>
            </div>
