            ...
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-slate-600">
                  Preferencias de cuenta: privacidad, alertas y opciones del dashboard.
                </p>
              </div>
            </div>
          </header>
          ...
          <section className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            <div className="p-6 sm:p-8">
              ...
              <h2 className="mt-2 text-lg sm:text-xl font-semibold text-slate-900">
                Estamos preparando tu configuración
              </h2>
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-1 text-sm text-slate-600">
                    Visibilidad del perfil y datos compartidos.
                  </p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <p className="text-sm font-semibold text-slate-900">Alertas</p>
                  <p className="mt-1 text-sm text-slate-600">
                    Preferencias de avisos y recordatorios.
                  </p>
                </div>
              </div>
            </div>
